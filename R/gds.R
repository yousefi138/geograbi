...
#'   datasets <- geograbr.retrieve.datasets(c("GPL8490")) ## 2sec
#' 
#'   ## all Illumina Infinium 27K/450K/EPIC DNA methylation datasets
#'   datasets <- geograbr.retrieve.datasets(c("GPL8490", "GPL13534", "GPL21145")) ## 5sec
#' 
#' @export
geograbr.retrieve.datasets <- function(gpl=NULL,retmax=10000) {
